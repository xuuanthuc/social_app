...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    context.read<AuthBloc>().add(OnChangedFullNameTextEvent(StaticVariable.myData?.fullName ?? ''));
    context.read<AuthBloc>().add(OnChangedBioTextEvent(StaticVariable.myData?.bio ?? ''));
    _phoneController.text = StaticVariable.myData?.phone ?? '';
    _bioController.text = StaticVariable.myData?.bio ?? '';
    _fullNameController.text = StaticVariable.myData?.fullName ?? '';
    _emailController.text = StaticVariable.myData?.email ?? '';
  }
